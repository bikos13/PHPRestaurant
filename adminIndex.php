...
<?php include('./admin/includes/headerAdmin.php'); ?>
        ...
        <?php if (isset($_SESSION['successmessage'])) { // View passed success messages - Constantine   ?>
            <div class="row">
                <div class="row">
                ...
                <div class="box">
                    ...
                    switch ($panelOption):
                        ...
                        case (preg_match('/manageTables.*/', $panelOption) ? true : false):
                            ...
                            break;
                        case (preg_match('/setReservationTables.*/', $panelOption) ? true : false):
                            include 'admin/tableReservationStep.php';
                            break;
                        case (preg_match('/reservationConfirmation.*/', $panelOption) ? true : false):
                            include 'admin/reservationConfirmation.php';
                            break;
                        case "setStoreHours":
        ...
        $_SESSION['warnings'] = "Access Denied to non-authorized area"; //If not admin
        header("Location: profile.php?panel=home");
    }
} else {
    $_SESSION['warnings'] = "Access Denied"; //If not loggedin
